...
>
> :point_right: The current version of this document can befound at [docs.snabble.io/docs/api/api_orders](https://docs.snabble.io/docs/api/api_orders).
...
| `paymentFailed`       | The payment of the order failed. See the paymentResult and paymentStatus for more information. |
